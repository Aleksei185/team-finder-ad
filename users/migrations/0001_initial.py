# Generated by Django 5.2.4 on 2026-05-16 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=12, unique=True, validators=[django.core.validators.RegexValidator('^\\+7\\d{10}$', 'Номер телефона должен быть в формате +7XXXXXXXXXX (10 цифр после +7)')], verbose_name='Телефон')),
